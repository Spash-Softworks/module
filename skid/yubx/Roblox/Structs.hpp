...
using r_getproperty_value_generic = uintptr_t(__fastcall*)(uintptr_t, ArgT*, const void*);
template<typename ReturnT>
using r_getproperty_value_generic2 = ReturnT(__fastcall*)(uintptr_t, const void*);